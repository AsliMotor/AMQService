...
{
    public class InvoiceLamaAngsuranChanged : IMessageHandler<LamaAngsuranChanged>
    {
        public IReportingRepository ReportingRepository { get; set; }
        public IInvoiceLogRepository InvoiceLogRepository { get; set; }
        public void Handle(LamaAngsuranChanged message)
        {
            ReportingRepository.Save<InvoiceLog>(
                new InvoiceLog()
                {
                    ...
                    Action = (int)InvoiceAction.LamaAngsuranChanged
                });
        }
    }
}
