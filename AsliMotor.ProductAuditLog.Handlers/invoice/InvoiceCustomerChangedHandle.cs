...
{
    public class InvoiceCustomerChangedHandle : IMessageHandler<CustomerChanged>
    {
        public IReportingRepository ReportingRepository { get; set; }
        public IInvoiceLogRepository InvoiceLogRepository { get; set; }
        public void Handle(CustomerChanged message)
        {
            ReportingRepository.Save<InvoiceLog>(
                new InvoiceLog()
                {
                    ...
                    Action = (int)InvoiceAction.CustomerChanged
                });
        }
    }
}
