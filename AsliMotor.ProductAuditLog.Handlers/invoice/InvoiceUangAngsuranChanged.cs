...
{
    public class InvoiceUangAngsuranChanged : IMessageHandler<UangAngsuranChanged>
    {
        public IReportingRepository ReportingRepository { get; set; }
        public IInvoiceLogRepository InvoiceLogRepository { get; set; }
        public void Handle(UangAngsuranChanged message)
        {
            ReportingRepository.Save<InvoiceLog>(
                new InvoiceLog()
                {
                    ...
                    Action = (int)InvoiceAction.UangAngsuranChanged
                });
        }
    }
}
