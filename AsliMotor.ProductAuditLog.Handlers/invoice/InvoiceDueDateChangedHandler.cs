...
{
    public class InvoiceDueDateChangedHandler : IMessageHandler<DueDateChanged>
    {
        public IReportingRepository ReportingRepository { get; set; }
        public IInvoiceLogRepository InvoiceLogRepository { get; set; }
        public void Handle(DueDateChanged message)
        {
            ReportingRepository.Save<InvoiceLog>(
                new InvoiceLog()
                {
                    ...
                    Action = (int)InvoiceAction.DueDateChanged
                });
        }
    }
}
